...
-- IDs de textura de bola prontos
...
som.SoundId = "rbxassetid://86694677899704"
som.Volume = 0.35
som.Looped = true
...
-- PAINEL PRINCIPAL (MENOR AGORA: 420x220)
...
content.Position = UDim2.new(0,126,0,36)
...
local function criarBotao3D(parent, texto, cor, callback, ordem)
    ...
    b.MouseEnter:Connect(function()
        TweenService:Create(b, TweenInfo.new(0.15), {Size=UDim2.new(1,-2,0,32)}):Play()
    end)
    b.MouseLeave:Connect(function()
        TweenService:Create(b, TweenInfo.new(0.15), {Size=UDim2.new(1,-6,0,30)}):Play()
    end)
...
-- NOVA FUNÇÃO: TROCAR TEXTURA DA BOLA
...
texStroke.Color = Color3.fromRGB(45,180,80)
texStroke.Thickness = 1.2
texStroke.Transparency = 0.5
texStroke.Parent = texBox
...
local function atualizarVolume(input)
    ...
    local vol = rel
    som.Volume = vol
    volLabel.Text = "🔊 Volume: " .. math.floor(vol*100) .. "%"
end
...
local musStroke = Instance.new("UIStroke")
musStroke.Color = Color3.fromRGB(45,180,80)
musStroke.Thickness = 1.2
musStroke.Transparency = 0.5
musStroke.Parent = musBox
...
criarBotaoSidebar("Ball", "⚽", 3)
criarBotaoSidebar("Música", "🎵", 4)
mostrarPagina("FPS")
...
print("[DYV HUB v0.2] Carregado com sucesso!")
